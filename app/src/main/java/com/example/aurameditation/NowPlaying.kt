...
import com.example.aurameditation.databinding.FragmentNowPlayingBinding
...
//                .into(binding.songImgNP)
            binding.songNameNP.text = PlayerActivity.musicName[PlayerActivity.songPosition].title
